...
ODDS_FORMAT = "decimal"
# Markets requested from the API. btts / team totals are "additional
# markets" on The Odds API and may not be available on all plans/leagues --
# the client degrades gracefully if they are missing.
ODDS_MARKETS = os.environ.get("ODDS_MARKETS", "h2h,totals,btts,team_totals")
